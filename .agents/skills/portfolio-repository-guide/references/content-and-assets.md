...
- La presentación elegida es una línea de tiempo vertical: círculos negros alineados con los títulos y conectados por una línea gris, con fecha o contexto y viñetas al lado. `VerticalTimeline` mide los párrafos para ubicar cada hito; el espacio vertical depende del contenido, no de la duración. Cada empresa tiene un bloque independiente: House of CB conecta únicamente sus dos hitos internos y 25Watts se presenta como un punto aislado. En freelance, las etapas usan una sangría de 14 puntos y ramas desde la línea de su empresa. Ninguna línea conecta empresas distintas.
