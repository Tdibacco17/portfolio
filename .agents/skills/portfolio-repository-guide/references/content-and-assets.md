...
- CV servido actualmente por el sitio: `/assets/pdf/TomasDiBacco_Resume.pdf`.
- Borradores del CV: `output/pdf/TomasDiBacco_CV_{FullStack,Frontend}_{ES,EN}.pdf`. Son cuatro combinaciones de orientación e idioma; todavía no están conectadas al botón de descarga.
